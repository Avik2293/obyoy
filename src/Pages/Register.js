                    ...
                    <Form onSubmit={handleSubmit}>
                        <Stack spacing={4}>
                            ...
                            <FormControl id="password" isRequired>
                                ...
                                <InputGroup>
                                    <Input type={showPassword ? "text" : "password"} placeholder='Type your Password here' px={2} w={'330px'} onChange={(e) => setPassword(e.target.value)} value={password} isRequired />
