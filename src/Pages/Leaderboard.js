...
const Leaderboard = () => {
    ...
    return (
        <Container pb={{ base: '2', md: '4', }} px={{ base: '3', md: '8', }} maxWidth={"1200px"} mx={'auto'} >
            ...
            <Text  fontSize="lg" fontWeight="bold" color='black' textAlign={'center'} my={2} p={3} >Leaderboard Full List</Text>
            
            <Text  fontSize="lg" fontWeight="bold" color='black' textAlign={'center'} mb={2} p={3} >Your Leaderboard No. : 22</Text>
